...
<div id="picDetailTitle">
	...
	<p class="playBtn">
		...
		<span class="pwg-icon pwg-icon-camera-info"></span>
		</a>
...
<!--[//详情标题]-->
<!--[图片]-->
<div id="picDetailImage">
	<div class="leftBtn"><a href="{$previous.U_IMG}"><img src="{$ROOT_URL}themes/default/images/leftArr.png" /></a></div>
	<div class="mid">{$ELEMENT_CONTENT}</div>
	<div class="rightBtn"><a href="{$next.U_IMG}"><img src="{$ROOT_URL}themes/default/images/rightArr.png" /></a></div>
	<p class="clear"></p>
</div>
<!--[//图片]-->
<!--[图片信息]-->
...
<div id="picDetailInfo">
	<span class="date"> {$INFO_POSTED_DATE}</span>
	<span class="cate">图片分类: {foreach from=$related_categories item=cat}{$cat}{/foreach}</span>
	<span class="author">作者: {$INFO_AUTHOR}</span>
	<span class="share">分享:
		<!--[百度分享栏]-->
...
<!--[//图片信息]-->
<!--[轮播图]-->
<div id="picDetailSlide">
	<div class="left">
		<a href="{$prevUrl}" title="上一图集">
			上一图集
		</a>
	</div>
	<div class="mid">
		<div class="leftBtn"><p>&lt;</p></div>
		<div class="mainPicSlide">
